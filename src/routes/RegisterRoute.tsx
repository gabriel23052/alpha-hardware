...
import classes from "./RegisterRoute.module.css";
...
const RegisterRoute = () => {
  ...
  return (
    <form className={`${classes.container}`}>
      ...
      <button
        className={`lneutral-xlight bg-primary text-default-b ${classes.submitBtn}`}
        disabled={!registerForm.isValid || !passwordsComparation.areEqual}
      >
        criar conta
      </button>
